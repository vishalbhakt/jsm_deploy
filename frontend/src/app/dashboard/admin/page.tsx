...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    ...
    if (loaders[section]) {
      loaders[section]().then((r: unknown) => { const res = r as { data: { results?: unknown[]; } | unknown[] }; const d = Array.isArray(res.data) ? res.data : (res.data as { results?: unknown[] }).results || []; setData(d); });
    }
  }, [section]);
